...
func (f *AccrualsClientAPI) GetOrder(ctx context.Context, orderID string) (*GetOrderResponse, error) {
...
func (f *AccrualsClientAPI) doGet(ctx context.Context, path string) ([]byte, error) {
	url := f.makeURL(path)
...
func (f *AccrualsClientAPI) makeURL(path string) string {
